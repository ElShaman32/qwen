...
class $ArqueoParcialTable extends ArqueoParcial
    with TableInfo<$ArqueoParcialTable, ArqueoParcialData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ArqueoParcialTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumn<double> montoEsperadoBs = GeneratedColumn<double>(
      'monto_esperado_bs', aliasedName, false,
      type: DriftSqlType.double, requiredDuringInsert: true);
  static const VerificationMeta _montoContadoBsMeta =
      const VerificationMeta('montoContadoBs');
  @override
  late final GeneratedColumn<double> montoContadoBs = GeneratedColumn<double>(
      'monto_contado_bs', aliasedName, false,
      type: DriftSqlType.double, requiredDuringInsert: true);
  static const VerificationMeta _diferenciaBsMeta =
      const VerificationMeta('diferenciaBs');
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'arqueo_parcial';
  @override
  VerificationContext validateIntegrity(Insertable<ArqueoParcialData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('monto_contado_bs')) {
      context.handle(
          _montoContadoBsMeta,
          montoContadoBs.isAcceptableOrUnknown(
              data['monto_contado_bs']!, _montoContadoBsMeta));
    } else if (isInserting) {
      context.missing(_montoContadoBsMeta);
    }
    if (data.containsKey('diferencia_bs')) {
      context.handle(
          _diferenciaBsMeta,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ArqueoParcialData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ArqueoParcialData(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      uuid: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}uuid'])!,
      ...
      montoEsperadoBs: attachedDatabase.typeMapping.read(
          DriftSqlType.double, data['${effectivePrefix}monto_esperado_bs'])!,
      montoContadoBs: attachedDatabase.typeMapping.read(
          DriftSqlType.double, data['${effectivePrefix}monto_contado_bs'])!,
      diferenciaBs: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}diferencia_bs'])!,
      nota: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}nota']),
  ...
  @override
  $ArqueoParcialTable createAlias(String alias) {
    return $ArqueoParcialTable(attachedDatabase, alias);
  }
}

class ArqueoParcialData extends DataClass
    implements Insertable<ArqueoParcialData> {
  final int id;
  final String uuid;
  final int aperturaId;
  final String usuarioId;
  final String usuarioNombre;
  final double montoEsperadoBs;
  final double montoContadoBs;
  final double diferenciaBs;
  final String? nota;
  final int fecha;
  const ArqueoParcialData(
      {required this.id,
      required this.uuid,
      required this.aperturaId,
      required this.usuarioId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['usuario_nombre'] = Variable<String>(usuarioNombre);
    map['monto_esperado_bs'] = Variable<double>(montoEsperadoBs);
    map['monto_contado_bs'] = Variable<double>(montoContadoBs);
    map['diferencia_bs'] = Variable<double>(diferenciaBs);
    if (!nullToAbsent || nota != null) {
      map['nota'] = Variable<String>(nota);
    }
  ...
  ArqueoParcialCompanion toCompanion(bool nullToAbsent) {
    return ArqueoParcialCompanion(
      id: Value(id),
      uuid: Value(uuid),
      aperturaId: Value(aperturaId),
      usuarioId: Value(usuarioId),
      usuarioNombre: Value(usuarioNombre),
      montoEsperadoBs: Value(montoEsperadoBs),
      montoContadoBs: Value(montoContadoBs),
      diferenciaBs: Value(diferenciaBs),
      nota: nota == null && nullToAbsent ? const Value.absent() : Value(nota),
      fecha: Value(fecha),
    );
  ...
  factory ArqueoParcialData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ArqueoParcialData(
      id: serializer.fromJson<int>(json['id']),
      ...
      usuarioNombre: serializer.fromJson<String>(json['usuarioNombre']),
      montoEsperadoBs: serializer.fromJson<double>(json['montoEsperadoBs']),
      montoContadoBs: serializer.fromJson<double>(json['montoContadoBs']),
      diferenciaBs: serializer.fromJson<double>(json['diferenciaBs']),
      nota: serializer.fromJson<String?>(json['nota']),
      fecha: serializer.fromJson<int>(json['fecha']),
    );
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'usuarioNombre': serializer.toJson<String>(usuarioNombre),
      'montoEsperadoBs': serializer.toJson<double>(montoEsperadoBs),
      'montoContadoBs': serializer.toJson<double>(montoContadoBs),
      'diferenciaBs': serializer.toJson<double>(diferenciaBs),
      'nota': serializer.toJson<String?>(nota),
      'fecha': serializer.toJson<int>(fecha),
    };
  ...
  ArqueoParcialData copyWith(
      ...
      ArqueoParcialData(
        ...
        usuarioNombre: usuarioNombre ?? this.usuarioNombre,
        montoEsperadoBs: montoEsperadoBs ?? this.montoEsperadoBs,
        montoContadoBs: montoContadoBs ?? this.montoContadoBs,
        diferenciaBs: diferenciaBs ?? this.diferenciaBs,
        nota: nota.present ? nota.value : this.nota,
        fecha: fecha ?? this.fecha,
      );
  ArqueoParcialData copyWithCompanion(ArqueoParcialCompanion data) {
    return ArqueoParcialData(
      id: data.id.present ? data.id.value : this.id,
      uuid: data.uuid.present ? data.uuid.value : this.uuid,
      aperturaId:
      ...
      montoEsperadoBs: data.montoEsperadoBs.present
          ? data.montoEsperadoBs.value
          : this.montoEsperadoBs,
      montoContadoBs: data.montoContadoBs.present
          ? data.montoContadoBs.value
          : this.montoContadoBs,
      diferenciaBs: data.diferenciaBs.present
          ? data.diferenciaBs.value
          : this.diferenciaBs,
  ...
  @override
  String toString() {
    return (StringBuffer('ArqueoParcialData(')
          ..write('id: $id, ')
          ..write('uuid: $uuid, ')
          ..write('aperturaId: $aperturaId, ')
          ..write('usuarioId: $usuarioId, ')
          ..write('usuarioNombre: $usuarioNombre, ')
          ..write('montoEsperadoBs: $montoEsperadoBs, ')
          ..write('montoContadoBs: $montoContadoBs, ')
          ..write('diferenciaBs: $diferenciaBs, ')
          ..write('nota: $nota, ')
          ..write('fecha: $fecha')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      ...
      (other is ArqueoParcialData &&
          ...
          other.usuarioNombre == this.usuarioNombre &&
          other.montoEsperadoBs == this.montoEsperadoBs &&
          other.montoContadoBs == this.montoContadoBs &&
          other.diferenciaBs == this.diferenciaBs &&
          other.nota == this.nota &&
          other.fecha == this.fecha);
}

class ArqueoParcialCompanion extends UpdateCompanion<ArqueoParcialData> {
  final Value<int> id;
  final Value<String> uuid;
  final Value<int> aperturaId;
  final Value<String> usuarioId;
  final Value<String> usuarioNombre;
  final Value<double> montoEsperadoBs;
  final Value<double> montoContadoBs;
  final Value<double> diferenciaBs;
  final Value<String?> nota;
  final Value<int> fecha;
  const ArqueoParcialCompanion({
    this.id = const Value.absent(),
    this.uuid = const Value.absent(),
    this.aperturaId = const Value.absent(),
    this.usuarioId = const Value.absent(),
    this.usuarioNombre = const Value.absent(),
    this.montoEsperadoBs = const Value.absent(),
    this.montoContadoBs = const Value.absent(),
    this.diferenciaBs = const Value.absent(),
    this.nota = const Value.absent(),
    this.fecha = const Value.absent(),
  });
  ArqueoParcialCompanion.insert({
    this.id = const Value.absent(),
    required String uuid,
    required int aperturaId,
    required String usuarioId,
    required String usuarioNombre,
    required double montoEsperadoBs,
    required double montoContadoBs,
    required double diferenciaBs,
    this.nota = const Value.absent(),
    required int fecha,
  })  : uuid = Value(uuid),
        ...
        diferenciaBs = Value(diferenciaBs),
        fecha = Value(fecha);
  static Insertable<ArqueoParcialData> custom({
    Expression<int>? id,
    Expression<String>? uuid,
    Expression<int>? aperturaId,
    Expression<String>? usuarioId,
    Expression<String>? usuarioNombre,
    Expression<double>? montoEsperadoBs,
    Expression<double>? montoContadoBs,
    Expression<double>? diferenciaBs,
    Expression<String>? nota,
    Expression<int>? fecha,
  }) {
    return RawValuesInsertable({
      ...
      if (usuarioNombre != null) 'usuario_nombre': usuarioNombre,
      if (montoEsperadoBs != null) 'monto_esperado_bs': montoEsperadoBs,
      if (montoContadoBs != null) 'monto_contado_bs': montoContadoBs,
      if (diferenciaBs != null) 'diferencia_bs': diferenciaBs,
      if (nota != null) 'nota': nota,
      if (fecha != null) 'fecha': fecha,
    });
  ...
  ArqueoParcialCompanion copyWith(
      {Value<int>? id,
      Value<String>? uuid,
      Value<int>? aperturaId,
      Value<String>? usuarioId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (montoContadoBs.present) {
      map['monto_contado_bs'] = Variable<double>(montoContadoBs.value);
    }
    if (diferenciaBs.present) {
      map['diferencia_bs'] = Variable<double>(diferenciaBs.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('ArqueoParcialCompanion(')
          ..write('id: $id, ')
          ..write('uuid: $uuid, ')
          ..write('aperturaId: $aperturaId, ')
          ..write('usuarioId: $usuarioId, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ArqueoParcialTable arqueoParcial = $ArqueoParcialTable(this);
...
typedef $$RetiroCajaTableProcessedTableManager = ProcessedTableManager<
    ...
    RetiroCajaData,
    PrefetchHooks Function()>;
typedef $$ArqueoParcialTableCreateCompanionBuilder = ArqueoParcialCompanion
    Function({
  Value<int> id,
  required String uuid,
  required int aperturaId,
...
typedef $$ArqueoParcialTableUpdateCompanionBuilder = ArqueoParcialCompanion
    Function({
  Value<int> id,
  Value<String> uuid,
  Value<int> aperturaId,
...
class $$ArqueoParcialTableFilterComposer
    extends Composer<_$AppDatabase, $ArqueoParcialTable> {
  $$ArqueoParcialTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<double> get montoContadoBs => $composableBuilder(
      column: $table.montoContadoBs,
      builder: (column) => ColumnFilters(column));
...
class $$ArqueoParcialTableOrderingComposer
    extends Composer<_$AppDatabase, $ArqueoParcialTable> {
  $$ArqueoParcialTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<double> get montoContadoBs => $composableBuilder(
      column: $table.montoContadoBs,
      builder: (column) => ColumnOrderings(column));
...
class $$ArqueoParcialTableAnnotationComposer
    extends Composer<_$AppDatabase, $ArqueoParcialTable> {
  $$ArqueoParcialTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<double> get montoContadoBs => $composableBuilder(
      column: $table.montoContadoBs, builder: (column) => column);
...
class $$ArqueoParcialTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ArqueoParcialTable,
    ArqueoParcialData,
    $$ArqueoParcialTableFilterComposer,
    $$ArqueoParcialTableOrderingComposer,
    $$ArqueoParcialTableAnnotationComposer,
    $$ArqueoParcialTableCreateCompanionBuilder,
    $$ArqueoParcialTableUpdateCompanionBuilder,
    (
      ArqueoParcialData,
      BaseReferences<_$AppDatabase, $ArqueoParcialTable, ArqueoParcialData>
    ),
    ArqueoParcialData,
    PrefetchHooks Function()> {
  $$ArqueoParcialTableTableManager(_$AppDatabase db, $ArqueoParcialTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ArqueoParcialTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ArqueoParcialTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ArqueoParcialTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String> uuid = const Value.absent(),
            Value<int> aperturaId = const Value.absent(),
            ...
            Value<String> usuarioNombre = const Value.absent(),
            Value<double> montoEsperadoBs = const Value.absent(),
            Value<double> montoContadoBs = const Value.absent(),
            Value<double> diferenciaBs = const Value.absent(),
            Value<String?> nota = const Value.absent(),
            Value<int> fecha = const Value.absent(),
          }) =>
              ArqueoParcialCompanion(
            id: id,
            uuid: uuid,
            aperturaId: aperturaId,
            usuarioId: usuarioId,
...
typedef $$ArqueoParcialTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ArqueoParcialTable,
    ArqueoParcialData,
    $$ArqueoParcialTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$ArqueoParcialTableTableManager get arqueoParcial =>
      $$ArqueoParcialTableTableManager(_db, _db.arqueoParcial);
