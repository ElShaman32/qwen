...
final _stockBajoProvider = FutureProvider<List<ProductoData>>(
    (ref) => ref.watch(productoDaoProvider).obtenerStockBajo());

final _fiadosPendientesProvider = FutureProvider<List<ClienteData>>(
    (ref) => ref.watch(clienteDaoProvider).conSaldoPendiente());
