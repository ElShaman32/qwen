      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
                ...
                Expanded(
                  child: Consumer(
                    builder: (context, ref, _) {
                      ...
                      // Plan gratis o no personalizado: texto libre (backward compatible)
                      ...
                      return StreamBuilder<List<dynamic>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final nombres = categorias
                              ...
                              .toList();
                          // Si el valor actual no está en la lista (legacy), agregarlo
                          final actual = _categoriaController.text.trim();
                          if (actual.isNotEmpty && !nombres.contains(actual)) {
            ...
            // Proveedor habitual (solo plan pagos)
            Consumer(
              builder: (context, ref, _) {
                final config = ref.watch(appConfigProvider);
                if (!config.puedePersonalizar) {
                ...
                return StreamBuilder<List<dynamic>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // Si el proveedor actual no está en la lista (legacy o borrado), mostrar
