...
class _VentasScreenState extends ConsumerState<VentasScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Banner suave: avisa al cajero que no ha abierto caja (solo cajeros)
      body: Column(
        children: [
  ...
  Future<void> _onProductoTap(
    ...
    // Bloqueo: cajero sin caja abierta no puede agregar al carrito
  ...
  /// Navega al carrito solo si el usuario puede vender.
...
/// Banner suave que avisa al cajero que no ha abierto caja.
/// No bloquea, solo informa. El bloqueo real está en _onProductoTap y _irAlCarrito.
