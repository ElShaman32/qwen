        ...
        children: [
          if (config.puedePersonalizar)
            FloatingActionButton.extended(
              heroTag: 'reporte_cajero',
              onPressed: () => context.push(AppRoutes.reporteCajero),
              icon: const Icon(Icons.leaderboard),
              label: const Text('Ventas por cajero'),
            ),
          const SizedBox(height: 12),
          FloatingActionButton.extended(
            heroTag: 'crear_cajero',
          ...
          children: [
            ...
            PopupMenuButton<String>(
              onSelected: (rol) async {
                ...
                await ref.read(rrhhServiceProvider).setRol(
                      u.uid,
                      rol,
            ...
            Switch(
              ...
              onChanged: (v) async {
                ...
                await ref.read(rrhhServiceProvider).setActivo(
                      u.uid,
                      v,
                      nombreUsuario: u.nombre,
                    );
